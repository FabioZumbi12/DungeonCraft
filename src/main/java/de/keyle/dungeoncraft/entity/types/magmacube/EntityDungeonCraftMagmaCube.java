...
package de.keyle.dungeoncraft.entity.types.magmacube;
...
public class EntityDungeonCraftMagmaCube extends EntityDungeonCraft {
    int jumpDelay;
    int size = 1;
    PathEntity lastPathEntity = null;

    public EntityDungeonCraftMagmaCube(World world) {
        super(world);
    }

    @Override
    protected String getDeathSound() {
        return "mob.magmacube." + (size > 1 ? "big" : "small");
    }
    ...
    public void setSize(int value) {
        ...
        EntityInfo es = EntityDungeonCraftMagmaCube.class.getAnnotation(EntityInfo.class);
        if (es != null) {
