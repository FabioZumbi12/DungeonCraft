...
package de.keyle.dungeoncraft.entity.types.mooshroom;
...
public class EntityDungeonCraftMooshroom extends EntityDungeonCraft {
    public EntityDungeonCraftMooshroom(World world) {
        super(world);
    }
