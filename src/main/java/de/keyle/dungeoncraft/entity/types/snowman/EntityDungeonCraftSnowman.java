...
package de.keyle.dungeoncraft.entity.types.snowman;
...
@EntityInfo(width = 0.4F, height = 1.8F)
public class EntityDungeonCraftSnowman extends EntityDungeonCraft {
    private static final boolean FIX_SNOW_TRACK = true;
    Map<Location, Integer> snowMap = new HashMap<Location, Integer>();

    public EntityDungeonCraftSnowman(World world) {
        super(world);
    }
