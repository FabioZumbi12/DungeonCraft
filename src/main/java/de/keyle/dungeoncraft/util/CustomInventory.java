...
public class CustomInventory implements IInventory, Listener {
    ...
    public CustomInventory(String inventroyName, int size) {
        ...
        setSize(size);
        DungeonCraftPlugin.getPlugin().getServer().getPluginManager().registerEvents(this, DungeonCraftPlugin.getPlugin());
    }
    ...
    void onPluginDisable(PluginDisableEvent event) {
        if (event.getPlugin().equals(DungeonCraftPlugin.getPlugin())) {
            close();
        }
    }
